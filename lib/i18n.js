...
const translations = {
  es: {
    ...
    'admin.users.total': 'Total Usuarios',
    'admin.users.active': 'Activos',
    'admin.users.disabled': 'Desactivados',
    'admin.companies.title': 'Empresas',
    'admin.companies.total': 'Total Empresas',
    'admin.tasks.title': 'Tareas Ejecutadas',
    'admin.revenue.title': 'Ingresos',
    'admin.revenue.total': 'Total',
    'admin.revenue.commission': 'Comisión (20%)',
    'admin.revenue.pending': 'Pendientes',
    'admin.health.title': 'Estado del Sistema',
    'admin.health.db': 'Base de Datos',
    'admin.health.services': 'Servicios',
    'admin.health.healthy': 'Saludable',
    'admin.health.degraded': 'Degradado',
    ...
    'settings.profile.current_password': 'Contraseña Actual',
    'settings.profile.new_password': 'Nueva Contraseña',
    'settings.profile.confirm_password': 'Confirmar Nueva Contraseña',
    'settings.company.title': 'Configuración de Empresa',
    'settings.company.name': 'Nombre de Empresa',
    'settings.company.description': 'Descripción',
    'settings.company.timezone': 'Zona Horaria',
    'settings.company.logo': 'Logo de Empresa',
    'settings.company.upload_logo': 'Subir Logo',
    'settings.api_keys.title': 'Claves API',
    'settings.api_keys.create': 'Crear Nueva Clave',
    'settings.api_keys.name': 'Nombre de Clave',
    'settings.api_keys.last_used': 'Último Uso',
    'settings.api_keys.never': 'Nunca',
    'settings.api_keys.revoke': 'Revocar',
    'settings.api_keys.confirm_revoke': '¿Estás seguro de revocar esta clave?',
    'settings.subscription.title': 'Suscripción',
    'settings.subscription.current_plan': 'Plan Actual',
    'settings.subscription.upgrade': 'Mejorar Plan',
    'settings.subscription.usage': 'Uso',
    'settings.withdrawal.title': 'Retirar Fondos',
    'settings.withdrawal.balance': 'Saldo Disponible',
    'settings.withdrawal.amount': 'Cantidad a Retirar',
    'settings.withdrawal.method': 'Método de Pago',
    'settings.withdrawal.details': 'Detalles de Pago',
    'settings.withdrawal.request': 'Solicitar Retiro',
    'settings.withdrawal.minimum': 'Mínimo $50 USD',
    'settings.withdrawal.pending': 'Tienes un retiro pendiente',
    'settings.quick_links.title': 'Enlaces Rápidos',
    'settings.quick_links.add': 'Agregar Enlace',
    'settings.quick_links.edit': 'Editar Enlace',
    'settings.quick_links.url': 'URL',
    'settings.quick_links.icon': 'Ícono',
  },
